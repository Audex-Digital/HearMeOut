...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-20 sm:py-32 bg-hmo-dark overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16 sm:mb-20">
          ...
          >
            In a world obsessed with likes, followers, and curated perfection, we wanted to create a sanctuary. A place where you can just be <strong className="text-white">you</strong>—messy, real, and unfiltered.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-16 sm:mb-20">
          {features.map((feature, index) => (
            <motion.div 
              key={index}
              className="bg-white/[0.02] border border-hmo-border p-8 sm:p-10 rounded-3xl hover:bg-white/[0.04] transition-all hover:translate-y-[-5px] hover:border-primary/50 group"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
        ...
        <motion.div 
          className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 border border-hmo-border rounded-[2rem] sm:rounded-[3rem] overflow-hidden grid grid-cols-1 lg:grid-cols-[1.2fr,0.8fr]"
        ...
        >
          <div className="p-8 sm:p-12 md:p-16">
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-8 sm:mb-10">Different from the rest</h3>
            <ul className="flex flex-col gap-6 sm:gap-8">
              <li className="flex items-start gap-4 text-sm sm:text-base text-slate-400">
                <X size={20} className="text-red-500 shrink-0 mt-1" />
                <span><strong className="text-white">Traditional Social Media:</strong> Focuses on image, status, and validation.</span>
              </li>
              <li className="flex items-start gap-4 text-sm sm:text-base text-slate-400">
                <X size={20} className="text-red-500 shrink-0 mt-1" />
                <span><strong className="text-white">Traditional Social Media:</strong> Often leads to anxiety and comparison.</span>
              </li>
              <li className="flex items-start gap-4 text-sm sm:text-base text-slate-400">
                <Check size={20} className="text-green-500 shrink-0 mt-1" />
                <span><strong className="text-white">HearMeOut:</strong> Focuses on feelings, authenticity, and relief.</span>
              </li>
              <li className="flex items-start gap-4 text-sm sm:text-base text-slate-400">
                <Check size={20} className="text-green-500 shrink-0 mt-1" />
                <span><strong className="text-white">HearMeOut:</strong> Designed to reduce anxiety and foster connection.</span>
              </li>
            </ul>
          </div>
