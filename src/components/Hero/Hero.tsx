...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-32 sm:pt-40 pb-20 sm:pb-32 overflow-hidden bg-white dark:bg-hmo-dark min-h-screen flex items-center transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-center text-center lg:text-left">
          <div className="hero-text">
            <motion.div 
              ...
              className="inline-block px-4 py-2 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-full text-xs sm:text-sm font-medium text-accent mb-6 sm:mb-8"
            >
              Anonymous & Safe
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-bold text-slate-900 dark:text-white mb-6 sm:mb-8 leading-[1.1]"
            >
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 max-w-xl mx-auto lg:mx-0 mb-10 sm:mb-12 leading-relaxed"
            >
            ...
            >
              ...
              <a 
                href="#about" 
                className="w-full sm:w-auto px-8 py-4 sm:px-10 sm:py-5 rounded-full text-base sm:text-lg font-bold text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:bg-slate-200 dark:hover:bg-white/10 transition-all text-center"
              >
                Learn More
              </a>
            </motion.div>
            ...
            >
              <div className="flex -space-x-3">
                {avatars.map((i) => (
                  <div key={i} className="w-8 h-8 rounded-full border-2 border-white dark:border-hmo-dark bg-slate-200 dark:bg-slate-800" />
                ))}
              </div>
          ...
          >
            <div className="relative w-full max-w-[500px] aspect-square">
               ...
               <div className="absolute inset-0 bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-800 dark:to-slate-900 border border-slate-200 dark:border-white/10 rounded-[3rem] overflow-hidden shadow-2xl">
                  <img 
              ...
              <motion.div 
                ...
                className="absolute top-[10%] -right-[5%] hidden sm:flex items-center gap-3 bg-white dark:bg-hmo-card/90 backdrop-blur-xl border border-slate-200 dark:border-white/10 p-4 rounded-2xl shadow-2xl z-20"
              >
                <div className="w-8 h-8 bg-green-500/20 rounded-lg flex items-center justify-center text-green-500">
                  <CheckCircle2 size={18} />
                </div>
                <span className="text-sm font-semibold text-slate-900 dark:text-white">Feeling understood</span>
              </motion.div>
