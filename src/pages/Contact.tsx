...
const Contact: React.FC = () => {
  return (
    <div className="min-h-screen bg-hmo-dark pt-32">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">support@hearmeout.com</p>
          ...
          >
            ...
            <button className="w-full bg-gradient-to-r from-primary to-accent text-white rounded-2xl py-4 font-bold text-sm shadow-xl shadow-primary/20 hover:shadow-primary/30 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group">
