    ...
    <div className="min-h-screen bg-hmo-dark flex items-center justify-center p-6 relative overflow-hidden transition-colors duration-300">
      ...
      >
        <header className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold hmo-text-primary mb-2 leading-tight">Welcome Back</h1>
          <p className="hmo-text-secondary text-sm font-medium tracking-wide">Continue your journey with the community.</p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold hmo-text-muted uppercase tracking-widest ml-1">Password</label>
            <div className="relative group">
          ...
          <div className="flex justify-end">
            <Link to="/reset-password" title="Forgot Password?" className="text-xs font-bold text-primary hover:text-accent transition-colors">
              Forgot Password?
            </Link>
          </div>
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <span className="text-[10px] font-bold hmo-text-muted uppercase tracking-widest">or</span>
        ...
        <button
          ...
          className="w-full mt-8 hmo-button-ghost py-4 flex items-center justify-center gap-3 disabled:opacity-50"
        >
